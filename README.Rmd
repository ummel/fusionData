...
The variable "recs_iecc_zone" tells us something about a respondent's location (their [IECC climate zone](https://basc.pnnl.gov/images/iecc-climate-zone-map)). This and other spatially-referenced variables are defined and named to be consistent with variables in the `geo-processed/geo_concordance.fst` file (more on this file below). This allows subsequent operations to intelligenty impute each respondent's location (see `?imputePUMA`).
