...
knitr::opts_chunk$set(echo = FALSE,
                      cache = TRUE, # Faster for testing/editing; will create /README_cache directory
                      comment = NA)
```
...
You will be prompted to enter your Github username and password. After the repository has been cloned to your local project directory, you can install and load the package itself:
...
For full functionality, it is necessary to download the remotely-stored processed survey microdata (.fst files). Read the following section ("Structure and usage") for more information about this. See `?getSurveyProcessed`.
...
You may be prompted to enter the password for the Google Drive account storing the remote files (password: fusethis!). The download will take a few minutes. After successful download, your fusionData "system" is ready to go.
