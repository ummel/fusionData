...
dir <- "fusion/RECS/2020/2019/input"
...
#prep <- readRDS("fusion/RECS/2020/2019/input/RECS_2020_2019_prep_UP.rds")
...
saveRDS(validation, file = paste0(out.path, "validation_UP.rds"))
